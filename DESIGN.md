...
| Adding somebody to the care team | 05 Capture that forgives | Undrawn, and law 3 applies. **Rebuilt 2026-08-12**, #361. **The name and the number lead**; the role, and the situation's own role chips, are behind "Add more". The role sat between them with up to six chips above it, so the number, which is the reason anybody adds a person, was the field furthest down. **No stages**: three fields is not a conversation and `StageDots` is for something walked in order. Review at #363 |
