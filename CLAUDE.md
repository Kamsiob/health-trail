...
19. **Accessibility is a gate, not a phase.** `DESIGN.md` section 9 clears before any issue closes, including for screens already built. Verified with the reader on, the font at maximum, and reduced motion actually enabled, never by reading the code.
