...
24. **Version one ships American English, and nothing else is verified.** Acceptance criteria read "verified in English". **RTL is not verified and is not a gate**, owner, 2026-08-16: other languages wait for 2.0. The four catalogs stay complete and checked, because letting the waiting three rot is how a deferral becomes a cancelation, but no screen is held open for a layout direction. Spanish, Chinese, Arabic deferred, not canceled. D180, superseding the RTL half of D141, which superseded D58.
