...
- **The instrumented suite is around 590 and the exact number is on the last run**, 2026-08-11. **Five classes are new**: `RemovalIsVisibleTest` seventeen, `FirstDaysTest` seven, `DocumentDateTest` four, `IncidentScreenTest` two, and **`ScreenReaderTest` grew from 61 cases to 91** covering every screen.
