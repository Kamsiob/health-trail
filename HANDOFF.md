...
- **598 instrumented tests pass**, full run 2026-08-11 at 01:33 on the unlocked phone. **Six classes are new or much bigger**: `RemovalIsVisibleTest` seventeen, `FirstDaysTest` seven, `DocumentDateTest` four, `IncidentScreenTest` two, `OwnMeasureTest` three, and **`ScreenReaderTest` from 61 cases to 92**, covering every screen.
