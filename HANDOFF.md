...
- **564 instrumented tests pass**, last full run 2026-08-11 on the unlocked phone. **Four classes are new**: `RemovalIsVisibleTest` seventeen, `FirstDaysTest` seven, `DocumentDateTest` four, `IncidentScreenTest` two.
