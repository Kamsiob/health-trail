...
- **#226 has a first slice**, 2026-08-11: twenty-two of the 115 candidates are done, chosen by one rule, that it is the person's own words and it reaches a `Text` directly. The trail was the biggest and the confirmation sheet was the worst. **93 left**, and the issue carries both what makes a candidate a defect and the three kinds that must never be touched: a field being edited, a draft on its way to the database, and anything building a filename.
