...
**Last rewritten:** 2026-08-12 at 17:30, on the Pixel 8, for a cold start.

**The next thing is #361, and it is the owner's own words about the app**: it looks like a data entry app, cluttered and visually complicated, and not on one screen but throughout. He named the document form, the notebook, the trail and the care team, and said explicitly that the notebook's fold is not the answer. **That issue carries the plan and the order.** Everything else on milestone 4 is smaller than it.
