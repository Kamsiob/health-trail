...
- **#226 has a first slice**, 2026-08-11: the trail and the unfiled tray isolate what somebody typed, which between them is most of the app's own sentences. **111 candidates left of 115**, and the issue carries what makes a candidate a defect and what makes one a false positive, which is the part worth reading before touching the rest.
